...
pub const CAMPUS_STYLE: &str = r##"{
  ...
  "layers": [
    ...
    {"id": "labels", "type": "symbol", "source": "scheme", "filter": ["has", "name"], "layout": {"text-field": ["get", "name"], "text-font": ["TimCampus"], "text-size": 14, "text-offset": [0, 1.1]}, "paint": {"text-color": "#1c1915"}}
  ]
}
"##;
