...
// Official bell times matching Timiryazevka schedule (09:00 start)
export const OFFICIAL_BELLS: Record<number, { start: string; end: string }> = {
  ...
  7: { start: "20:00", end: "21:35" },
}

export const BELL_TIMES = [
  { num: 1, start: "09:00", end: "10:35", label: "1-я пара" },
  { num: 2, start: "10:45", end: "12:20", label: "2-я пара" },
  { num: 3, start: "13:00", end: "14:35", label: "3-я пара" },
  { num: 4, start: "14:45", end: "16:20", label: "4-я пара" },
  { num: 5, start: "16:30", end: "18:05", label: "5-я пара" },
  { num: 6, start: "18:15", end: "19:50", label: "6-я пара" },
  { num: 7, start: "20:00", end: "21:35", label: "7-я пара" },
]

export const BREAKS = [
  { afterNum: 1, durationMin: 10, name: "Перерыв между 1 и 2 парами (10 мин)" },
  { afterNum: 2, durationMin: 40, name: "Большой обеденный перерыв (40 мин, 12:20–13:00)" },
  { afterNum: 3, durationMin: 10, name: "Перерыв между 3 и 4 парами (10 мин)" },
  { afterNum: 4, durationMin: 10, name: "Перерыв между 4 и 5 парами (10 мин)" },
  { afterNum: 5, durationMin: 10, name: "Перерыв между 5 и 6 парами (10 мин)" },
  { afterNum: 6, durationMin: 10, name: "Перерыв между 6 и 7 парами (10 мин)" },
]
