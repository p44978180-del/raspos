...
export const BUILDING_DETAILS: {
  ...
  corp1: {
    name: "1-й учебный корпус (Главный)",
    short: "УК-1",
    address: "Тимирязевская ул., 49",
    floors: 4,
    note: "Ректорат, Институт агробиотехнологии, Студенческий МФЦ, столовая",
  ...
  corp2: {
    ...
    floors: 3,
    note: "Ботанические кафедры, физиология растений, селекция",
    coords: [37.5550, 55.8315],
  },
  corp3: {
    ...
    floors: 3,
    note: "Земледелие, растениеводство, зоотехния, агрометеорология",
  ...
  corp4: {
    ...
    floors: 3,
    note: "Компьютерные классы, ИТ-кафедры, высшая математика",
    coords: [37.5505, 55.8295],
  },
  corp6: {
    name: "6-й учебный корпус (Зоотехния)",
    short: "УК-6",
    address: "Тимирязевская ул., 44с2",
    floors: 4,
    note: "Институт зоотехнии и биологии, ветеринария, аквариальные лаборатории",
    coords: [37.5510, 55.8320],
  },
  corp8: {
    name: "8-й учебный корпус (Лесоводство)",
    short: "УК-8",
    address: "Лиственничная аллея, 3",
    floors: 3,
    note: "Лесоводство, ландшафтный дизайн, дендрология",
    coords: [37.5560, 55.8320],
  },
  corp9: {
    name: "9-й учебный корпус (Экономический)",
    short: "УК-9",
    address: "Лиственничная аллея, 2",
    floors: 4,
    note: "Институт экономики и управления АПК, буфет",
    coords: [37.5490, 55.8290],
  },
  corp10: {
    name: "10-й учебный корпус (Мелиорация)",
    short: "УК-10",
    address: "Лиственничная аллея, 9",
    floors: 4,
    note: "Мелиорация, гидротехника, водное хозяйство",
    coords: [37.5595, 55.8340],
  },
  corp11: {
    name: "11-й учебный корпус",
    short: "УК-11",
    address: "Лиственничная аллея, 11",
    floors: 2,
    note: "Учебно-производственные мастерские",
    coords: [37.5610, 55.8345],
  },
  corp12: {
    name: "12-й учебный корпус (Теплицы)",
    short: "УК-12",
    address: "ул. Прянишникова, 19",
    floors: 3,
    note: "Институт гидромелиорации, опытные теплицы",
    coords: [37.5450, 55.8350],
  },
  corp17: {
    name: "17-й корпус (Почвенно-агрономический)",
    short: "К-17",
    address: "Тимирязевская ул., 54",
    floors: 4,
    note: "Почвоведение, геология, гуманитарный факультет, столовая 17к",
    coords: [37.5420, 55.8330],
  },
  corp26: {
    name: "26-й учебный корпус (Поточные залы)",
    short: "УК-26",
    address: "Тимирязевская ул., 49с2",
    floors: 4,
    note: "Большие поточные лекционные залы, буфет 26к",
    coords: [37.5550, 55.8310],
  },
  corp28: {
    name: "28-й корпус (Инженерный им. Горячкина)",
    short: "Инж-28",
    address: "Лиственничная аллея, 2Д",
    floors: 4,
    note: "Институт механики и энергетики им. В.П. Горячкина",
    coords: [37.5635, 55.8265],
  },
  corp29: {
    name: "29-й корпус (Цифровой центр АПК)",
    short: "Цифр-29",
    address: "Лиственничная аллея, 16",
    floors: 3,
    note: "Цифровой институт, IT-лаборатории, Digital Hub",
    coords: [37.5410, 55.8420],
  },
  agrochem: {
    name: "Корпус агрохимии (22/23 корпус)",
    short: "Агрохим-22",
    address: "ул. Прянишникова, 6",
    floors: 3,
    note: "Агрохимия, биохимия, защита растений, кафе «Тимирязев»",
    coords: [37.5603, 55.8280],
  },
  admin: {
    name: "Ректорат (Главное историческое здание)",
    short: "Ректорат",
    address: "Тимирязевская ул., 49",
    floors: 3,
    note: "Ректорат, учёный совет, приёмная комиссия, КПП-1",
    coords: [37.5480, 55.8305],
  },
  lib: {
    name: "ЦНБ им. Н.И. Железнова (Библиотека)",
    short: "ЦНБ",
    address: "Лиственничная аллея, 2к1",
    floors: 3,
    note: "Читальные залы, ЭБС, коворкинг, кофейня",
    coords: [37.5530, 55.8300],
  },
  sport: {
    ...
    floors: 2,
    note: "Бассейн 25м, тренажёрные залы, стадион «Тимирязевец»",
    coords: [37.5570, 55.8330],
  },
  canteen: {
    name: "Комбинат питания «Тимирязевская»",
    short: "Столовая КП",
    address: "Лиственничная аллея, 5",
    floors: 2,
    note: "Главная студенческая столовая, два зала",
    coords: [37.5575, 55.8350],
  },
}

export const BUILDING_MAP_QUERIES: Record<string, string> = {
  corp1: "РГАУ+МСХА+1+учебный+корпус+Тимирязевская+49",
  corp2: "РГАУ+МСХА+2+учебный+корпус+Тимирязевская+47",
  corp3: "РГАУ+МСХА+3+учебный+корпус+Тимирязевская+45",
  corp4: "РГАУ+МСХА+4+учебный+корпус+Тимирязевская+44",
  corp6: "РГАУ+МСХА+6+учебный+корпус+зоотехния",
  corp8: "РГАУ+МСХА+8+учебный+корпус+Лиственничная",
  corp9: "РГАУ+МСХА+9+учебный+корпус+экономический",
  corp10: "РГАУ+МСХА+10+учебный+корпус+мелиорация",
  corp11: "РГАУ+МСХА+11+учебный+корпус+Лиственничная+11",
  corp12: "РГАУ+МСХА+12+учебный+корпус+Прянишникова+19",
  corp17: "РГАУ+МСХА+17+корпус+Тимирязевская+54",
  corp26: "РГАУ+МСХА+26+учебный+корпус",
  corp28: "РГАУ+МСХА+инженерный+корпус+Горячкина+Лиственничная+2Д",
  corp29: "РГАУ+МСХА+29+корпус+цифровой+центр+Лиственничная+16",
  agrochem: "РГАУ+МСХА+корпус+агрохимии+Прянишникова+6",
  engineering: "РГАУ+МСХА+инженерный+корпус+Лиственничная+2Д",
  sport: "РГАУ+МСХА+спортивный+комплекс+СОК+Лиственничная+12Б",
  lib: "ЦНБ+Железнова+РГАУ+МСХА+Лиственничная+2",
  admin: "РГАУ+МСХА+ректорат+Тимирязевская+49",
  canteen: "РГАУ+МСХА+столовая+Тимирязевская+Лиственничная+5",
}

export const DORM_COORDS: Record<string, [number, number]> = {
  "Общежитие №1": [37.5520, 55.8340],
  "Общежитие №2": [37.5528, 55.8335],
  "Общежитие №3": [37.5540, 55.8340],
  "Общежитие №4": [37.5545, 55.8330],
  "Общежитие №5": [37.5555, 55.8338],
  "Общежитие №6": [37.5565, 55.8348],
  "Общежитие №7": [37.5560, 55.8290],
  "Общежитие №8": [37.5572, 55.8352],
  "Общежитие №9": [37.5570, 55.8270],
  "Общежитие №10": [37.5648, 55.8268],
  "Общежитие №11": [37.5580, 55.8340],
  "Общежитие №13": [37.5590, 55.8360],
  "Общежитие №16": [37.5585, 55.8250],
}
